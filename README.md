...
- Common algebraic, trigonometric, complex identities 
- Integral, convolution, FS, FT, LT table
- Frequently used problems and corner cases
- Trivial yet convenient formula (E. $$\sin(n\pi) = 0$$)
...
- Guarantee of correctness/complete coverage
...
5. Frequently used symbols and commands are abbreviated in the `.tex` file to save my pinky finger :)
